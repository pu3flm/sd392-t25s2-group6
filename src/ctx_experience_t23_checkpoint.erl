-module(ctx_experience_t23_checkpoint).
...
-define(NAME, ctx_experience_t23_checkpoint).

%% Test-local in-memory checkpoint owner. It deliberately has no file, DETS,
%% ETS, network, port, or governing-runtime write path.
...
handle_call({load, Key}, _From, State) ->
